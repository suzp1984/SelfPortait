...
%\subsection{专业}
\cventry{2014.5-16.4}{Software Engineer}{Iboxpay Shenzhen}{}{}{Android app developer %\newline{}
}
\cventry{2013.9-14.4}{Software Engineer}{Topwise3g Shenzhen}{}{}{Android System Developer}
\cventry{2012.2-12.8}{Software Engineer}{Topwise Shenzhen}{}{}{Android System Developer}
\cventry{2010.4-12.1}{Software Engineer}{Topwise3g Shenzhen}{}{}{As a System engineer of Android %\newline{}
% 工作内容:
% \begin{itemize}
...
\cvitem{Languages}{\small C, Emacs Lisp, Python, Java, javascript, node.js, \LaTeX{}}
...
\cventry{2014.5-15.4}{Android App Developer}{IBoxPay Co. Ltd}{ShenZhen}{}{Refactor and Developer the former CashBox App project.\newline{}%
Description:%
\begin{itemize}
\item CashBox App is IboxPay's core project, which consists of the mobile client side app, the backend side trading system and an intelligent terminal hardware. This is what we called mobile POS, a box hardware must be connected to the mobile side CashBox app, then swipe your bank card in that little portable hardware, then you can trading with the merchants.
\item The intelligent terminals can be classified by its connection types, there are Audio jack, Bluetooth Classic, Bluetooth Low Energy and Uart serial port.
\end{itemize}
Achievement:%
\begin{itemize}
\item Refactor the code according to the Object-Oriented Principal, decoupled the code by introduced an isolated module which can be reused in another projects.
\item wrote the software design document, make the development process sustainable and readable.
\item make the code reusable in another project by introduce a Connection interface, when the new terminal device appears with new type of communication type, just to rewrite the Connection interface, then the whole module can be reusble.
\end{itemize}}
\cvitem{}{}
...
Description:%
\begin{itemize}
\item Android App Architecture, promote MVP.
...
Description:%
\begin{itemize}
\item Reseach and analysis Bluetooth Low Energy application at Broadcom's BLE board.
\end{itemize}
Architecture:%
\begin{itemize}
...
Description:%
\begin{itemize}
\item The factory auto running test toolkit is running in an autotest machine which test the newly produced PCB board.
\end{itemize}
Architecture:%
\begin{itemize}
...
\cvitem{}{}
\subsection{Android System Developer}
\cventry{2010.5-12.8}{Software Developer}{Topwise3g \& Topwise Co. Ltd}{Shenzhen}{}{%
Description:%
\begin{itemize}
\item Android framework and System Developer from version 1.6 to 4.3, My duties include integration Makefile development and HAL layer developer.
\end{itemize}
}
