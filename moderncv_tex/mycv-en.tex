...
\cventry{2014.5-now}{Software Engineer}{Iboxpay Shenzhen}{}{}{Android app developer %\newline{}
...
\cvitem{Languages}{\small C(expert), Emacs Lisp, Bash shell, Python, Java, node.js}
...
\cvitem{4.}{rebuild the Android build system to fulfill the target of stronger customization, developed by Bash Shell, Python.}

\cvitem{5.}{Porting and maintance the Wifi and Bluetooth module, and familiar with wpa\_supplicant and bluez stack.}

\cvitem{6.}{android HAL layer development, mainly C source code, the adapter layers for sensors, GPS.}

\cvitem{7.}{Kernel configuration customization tools development, developed by C, there are an user client to generate a block of data(firmware), and a kernel part to parser that data block when it startup.}

\cvitem{8.}{Factory Test toolkits: \newline{}
