...
\section{工作背景}
%\subsection{专业}
\cventry{2010.4-2014}{软件工程师}{深圳鼎智}{}{}{从事Android系统的研发工作 %\newline{}
% 工作内容:
% \begin{itemize}
...
\cvitem{Languages}{C(熟练), Emacs Lisp(熟练), Bash shell(熟悉), Python(熟悉), Java(熟悉), node.js(了解)}
\cvitem{GUI programming} {Qt, PyQt(熟悉)}
...
\cvitem{7.}{Bluetooth v4.0 Low Energy 协议开发工作，熟悉bluedroid, bluez 协议栈。}
