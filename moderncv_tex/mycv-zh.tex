...
\section{工作背景}
%\subsection{专业}
\cventry{2014.5-16.3}{软件工程师}{深圳盒子支付}{}{}{钱盒客户端研发 %\newline{}
}
...
\cvitem{Languages}{C, Emacs Lisp, Python, Java, javascript, node.js}
...
\section{工作的业绩及其职业技能}
\cvitem{1.}{虚拟化工作，xen/kvm, docker, vagrant}
\cvitem{2.}{iboxpay钱盒app重构}
\cvitem{3.}{Bluetooth v4.0 Low Energy 可穿戴设备开发。}
\cvitem{4.}{Android 系统开发}
\cvitem{5.}{web前端开发，熟悉常用前端框架，bootstrap, polymer; 以及JS的MVC框架angularJs，reactJs.}
