...
\section{工作背景}
%\subsection{专业}
\cventry{2014.5-16.3}{软件工程师}{深圳盒子支付}{}{}{钱盒Android客户端研发 %\newline{}
}
...
\section{工作的业绩及其职业技能}
\cvitem{1.}{Reactive, Realtime, Hybrid mobile App developement}
\cvitem{2.}{Android APP 架构: MVP, MVVM}
\cvitem{3.}{IOS}
\cvitem{4.}{Bluetooth v4.0 Low Energy}
\cvitem{5.}{虚拟化工作，xen/kvm, docker, vagrant}
\cvitem{6.}{python编程能力}


\section{期望工作}
\cvitem{1.}{hybrid mobile 开发工作}
\cvitem{2.}{期望月薪25K}
